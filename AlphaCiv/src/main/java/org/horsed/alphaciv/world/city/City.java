...
public interface City {
	...
	/**
	 * increases the production amount of this city by the specified value.
	 */
	public void incrementProductionAmount(int value);

	/**
	 * decreases the production amount of this city by the specified value.
	 */
	public void decrementProductionAmount(int value);

	/**
	 * return the amount of units this city can produce.
	 */
